...
export const METRICS = ["speechEndToReplyMs", "speechEndToFillerMs", "sttMs", "intentMs", "brainFirstTokenMs", "ttsFirstAudioMs", "cancellationSettlementMs"] as const;
...
const LABELS: Record<typeof METRICS[number], string> = {
  intentMs: "intent", speechEndToReplyMs: "speech_end→reply", speechEndToFillerMs: "speech_end→filler", sttMs: "STT", brainFirstTokenMs: "brain first token", ttsFirstAudioMs: "TTS first audio", cancellationSettlementMs: "cancellation settle",
};
